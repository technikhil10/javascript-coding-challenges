...
john.calcBMI() > mark.calcBMI() ? console.log(`John's BMI (${john.calcBMI()}) is higher than Mark's(${mark.calcBMI()})`): console.log(`Mark's BMI (${mark.calcBMI()}) is higher than John's(${john.calcBMI()})`);
